...
const Reel = ({ reel, currentUser, onLike, onComment }) => {
  ...
  const handleLike = async () => {
    try {
      ...
      if (isLiked) {
        await axios.post(`https://back-nipj.onrender.com/api/reels/${reel._id}/unlike`, null, {
          headers: {
            'x-auth-token': token
          }
        });
        ...
        await axios.post(`https://back-nipj.onrender.com/api/reels/${reel._id}/like`, null, {
          headers: {
            'x-auth-token': token
          }
        });
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://back-nipj.onrender.com/api/reels/${reel._id}/comment`,
        { text: commentText },
        {
          headers: {
            'x-auth-token': token
