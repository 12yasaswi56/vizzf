...
//         if (token) {
//           await axios.post(`https://back-nipj.onrender.com/api/stories/${story._id}/view`, {}, {
    ...
    const fetchViewers = async () => {
      try {
        ...
        if (token && story.user?._id === user?._id) {
          const response = await axios.get(`https://back-nipj.onrender.com/api/stories/${story._id}/viewers`, {
            headers: { 'x-auth-token': token }
          });
